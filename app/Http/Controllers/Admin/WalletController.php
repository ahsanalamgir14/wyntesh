...
class WalletController extends Controller
{
    ...
    public function getIncomeWalletDebitTransactions(Request $request)
    {
        $User=JWTAuth::user();
    ...
    public function debitIncomeBalance(Request $request){
        $user=JWTAuth::user();
        ...
        $balance=floatval($debited_from->member->income_wallet_balance);
        $amount=$request->amount;
        $TransactionType=TransactionType::where('name','Debit (Admin)')->first();
        ...
        if($TransactionType){
            $WalletTransaction=new IncomeWalletTransactions;
            ...
            $final_balance=$balance-$amount;
            $debited_from->member->income_wallet_balance=$final_balance;
