...
export const constantRoutes = [{
    ...
    },
    {
        path: '/login',
        component: () =>
            import ('@/views/auth/login/index'),
        hidden: true
    },
    {
        path: '/register',
        component: () =>
            import ('@/views/auth/register/index'),
        hidden: true
    },
    {
        path: '/forgot-password',
        component: () =>
            import ('@/views/auth/forgot-pass/index'),
        hidden: true
    },
    {
        path: '/reset-password',
        component: () =>
            import ('@/views/auth/reset-password/index'),
        hidden: true
    },
    {
        path: '/auth-redirect',
        component: () =>
            import ('@/views/auth/login/AuthRedirect'),
        hidden: true
    },
    {
        path: '/404',
    ...
    },
    {
        path: '/invoice/:id',
        component: () =>
            import ('@/views/user/shopping/invoice'),
        hidden: true,
    },
    {
        path: '/payout-report/:id',
        component: () =>
            import ('@/views/user/payouts/payout-report'),
        hidden: true,
    },
    {
        path: '/',
...
export const asyncRoutes = [

    {
        ...
        children: [{
            path: 'manage',
            component: () =>
                import ('@/views/superadmin/admins-and-roles/index'),
    ...
    },
    {
        ...
        children: [{
                path: 'incomes',
                component: () =>
                    import ('@/views/admin/plan/incomes'),
                name: 'Incomes',
            ...
            },
            {
                path: 'payout-types',
                component: () =>
                    import ('@/views/admin/plan/payout-types'),
                name: 'Payout Types',
    ...
    },
    {
        ...
        children: [{
                ...
                component: () =>
                    import ('@/views/superadmin/configs/transaction-types'),
            ...
            },
            {
                path: 'payment-modes',
                component: () =>
                    import ('@/views/superadmin/configs/payment-modes'),
                name: 'Payment Modes',
            ...
            },
            {
                path: 'statuses',
                component: () =>
                    import ('@/views/superadmin/configs/statuses'),
                name: 'Statuses',
    ...
    },
    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/user/reports/wall-of-wyntash'),
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'activate',
                component: () =>
                    import ('@/views/admin/network/activate-accounts'),
                name: 'Activate IDs',
                hidden: true,
            ...
            },
            {
                path: 'add',
                component: () =>
                    import ('@/views/admin/network/members/add'),
                name: 'Add Members',
            ...
            },
            {
                path: 'geneology',
                component: () =>
                    import ('@/views/admin/network/geneology/index'),
                name: 'Geneology',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/network/geneology/member'),
    ...
    },
    {
        ...
        children: [{
                path: 'pending',
                component: () =>
                    import ('@/views/admin/kycs/pending'),
                name: 'Pending',
            ...
            },
            {
                path: 'approved',
                component: () =>
                    import ('@/views/admin/kycs/approved'),
                name: 'Approved',
            ...
            },
            {
                path: 'rejected',
                component: () =>
                    import ('@/views/admin/kycs/rejected'),
                name: 'Rejected',
    ...
    },
    {
        ...
        children: [{
                path: 'add',
                component: () =>
                    import ('@/views/admin/contests/add'),
                name: 'Create Contest',
            ...
            },
            {
                path: 'championship',
                component: () =>
                    import ('@/views/user/contests/index'),
                name: 'WCL',
    ...
    },
    {
        ...
        children: [{
                path: 'add',
                component: () =>
                    import ('@/views/admin/products/add'),
                name: 'Add Product',
            ...
            },
            {
                path: 'all',
                component: () =>
                    import ('@/views/admin/products/all-products'),
                name: 'All Products',
            ...
            },
            {
                path: 'categories',
                component: () =>
                    import ('@/views/admin/products/categories'),
                name: 'Categories',
            ...
            },
            {
                path: 'size-variants',
                component: () =>
                    import ('@/views/admin/product-configurations/size-variants'),
                name: 'Size Variant',
            ...
            },
            {
                path: 'color-variants',
                component: () =>
                    import ('@/views/admin/product-configurations/color-variants'),
                name: 'Color Variant',
            ...
            },
            {
                path: 'stock',
                component: () =>
                    import ('@/views/admin/product-configurations/product-stocks'),
                name: 'Stock',
            ...
            },
            {
                path: 'inward-outward',
                component: () =>
                    import ('@/views/admin/product-configurations/inward-outward'),
                name: 'Inward/Outward',
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'transfer',
                component: () =>
                    import ('@/views/admin/pins/transfer'),
                name: 'Transfer Pins',
                hidden: false,
            ...
            },
            {
                path: 'transfer-log',
                component: () =>
                    import ('@/views/admin/pins/pin-transfer-logs'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/pins/pending-pin-requests'),
                name: 'PIN Requests',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/pins/approved-pin-requests'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/pins/rejected-pin-requests'),
    ...
    },
    {
        ...
        children: [{
                ...
                component: () =>
                    import ('@/views/admin/wallet/index'),
                name: 'With. Requests',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/transfer-request'),
                name: 'Trans. Requests',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/credit-requests'),
            ...
            },
            {
                path: 'withdrawals',
                component: () =>
                    import ('@/views/admin/wallet/withdrawals'),
                name: 'Withdrawals',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/transfer'),
            ...
            },
            {
                path: 'debit-balance',
                component: () =>
                    import ('@/views/admin/wallet/debit-balance'),
                name: 'Debit Balance',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/debit-income-balance'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/debit-luxury-balance'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/transactions'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/income-transactions'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/wallet/luxury-wallet-transactions'),
...

    {
        ...
        children: [{
                path: 'generate',
                component: () =>
                    import ('@/views/admin/payouts/generate'),
                name: 'All Payouts',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/payouts/matching-point'),
            ...
            },
            {
                path: 'incomes',
                component: () =>
                    import ('@/views/admin/payouts/incomes'),
                name: 'Incomes',
            ...
            },
            {
                path: 'member/payouts',
                component: () =>
                    import ('@/views/admin/payouts/member-payouts'),
                name: 'Member Payouts',
            ...
            },
            {
                path: '/member/incomes',
                component: () =>
                    import ('@/views/admin/payouts/member-incomes'),
                name: 'Member Incomes',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/payouts/member-income-holdings'),
                name: 'Income on Hold',
                hidden: false,
            ...
            },
            {
                path: 'rewards',
                component: () =>
                    import ('@/views/admin/payouts/rewards'),
                name: 'Rewards',
                hidden: false,
    ...
    },
    {
        ...
        children: [{
                path: 'gst-report',
                component: () =>
                    import ('@/views/admin/reports/gst-report'),
                name: 'GST',
            ...
            },
            {
                path: 'tds-report',
                component: () =>
                    import ('@/views/admin/reports/tds-report'),
                name: 'TDS',
            ...
            },
            {
                path: 'wallet-balance',
                component: () =>
                    import ('@/views/admin/reports/top-wallet'),
                name: 'Wallet Balance',
                hidden: false,
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/reports/payout-monthwise'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/reports/member-business'),
                hidden: true,
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/reports/monthly-overview'),
            ...
            },
            {
                path: 'joining-report',
                component: () =>
                    import ('@/views/admin/reports/joining-report'),
                name: 'Joinings',
    ...
    },
    {
        ...
        children: [

            {
                ...
                component: () =>
                    import ('@/views/admin/website/newses/index'),
                name: 'News & Updates',
            ...
            },
            {
                path: 'achievers',
                component: () =>
                    import ('@/views/admin/website/achievers/index'),
                name: 'Achievers',
            ...
            },
            {
                path: 'downloads',
                component: () =>
                    import ('@/views/admin/website/downloads/index'),
                name: 'Downloads',
            ...
            },
            {
                path: 'gallery',
                component: () =>
                    import ('@/views/admin/website/gallery/index'),
                name: 'Gallery',
            ...
            },
            {
                path: 'popups',
                component: () =>
                    import ('@/views/admin/website/popups/index'),
                name: 'Popups',
                meta: { title: 'Popups', icon: 'fas fa-image', color: 'color:#3498DB', affix: true, roles: ['admin'] }
            },
            {
                path: 'software-popups',
                component: () =>
                    import ('@/views/admin/website/software-popups/index'),
                name: 'Software Popups',
                meta: { title: 'Software Popups', icon: 'fas fa-image', color: 'color:#FF5733', affix: true, roles: ['admin'] }
            },
            {
                path: 'sliders',
                component: () =>
                    import ('@/views/admin/website/sliders/index'),
                name: 'Sliders',
            ...
            },
            {
                path: 'testimonials',
                component: () =>
                    import ('@/views/admin/website/testimonials/index'),
                name: 'Testimonials',
            ...
            },
            {
                path: 'bank-partners',
                component: () =>
                    import ('@/views/admin/website/bank-partners/index'),
                name: 'Bank Partners',
    ...
    },
    {
        ...
        children: [{
                path: 'notice',
                component: () =>
                    import ('@/views/admin/settings/notices'),
                name: 'Notice',
                hidden: false,
            ...
            },
            {
                path: 'welcome-letter',
                component: () =>
                    import ('@/views/admin/settings/welcome-letter'),
                name: 'Welcome Letter',
                hidden: false,
            ...
            },
            {
                path: 'emails',
                component: () =>
                    import ('@/views/admin/settings/emails'),
                name: 'Emails',
                hidden: false,
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/admin/settings/company-details'),
    ...
    },
    {
        ...
        children: [{
            ...
            component: () =>
                import ('@/views/admin/marketing/email-and-message'),
            name: 'Send SMS/Email',
    ...
    },
    {
        ...
        children: [{
                path: 'inquiries',
                component: () =>
                    import ('@/views/admin/inquiries/index'),
                name: 'Inquiries',
            ...
            },
            {
                path: 'tickets',
                component: () =>
                    import ('@/views/admin/support/index'),
                name: 'Tickets',
...

    {
        ...
        children: [{
                path: 'profile',
                component: () =>
                    import ('@/views/user/account/Profile'),
                name: 'Profile & KYC',
            ...
            },
            {
                path: 'welcome-letter',
                component: () =>
                    import ('@/views/user/account/welcome-letter'),
                name: 'Welcome Letter',
                hidden: true,
            ...
            },
            {
                path: 'id-card',
                component: () =>
                    import ('@/views/user/account/id-card'),
                name: 'ID Card',
            ...
            },
            {
                path: 'activate',
                component: () =>
                    import ('@/views/user/account/activate-account'),
                name: 'Activate ID',
                hidden: true,
            ...
            },
            {
                path: 'addresses',
                component: () =>
                    import ('@/views/user/account/addresses'),
                name: 'Addresses',
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'geneology',
                component: () =>
                    import ('@/views/user/network/my-genealogy'),
                name: 'Geneology',
            ...
            },
            {
                path: 'geneology/member/:id',
                component: () =>
                    import ('@/views/user/network/member-genealogy'),
                name: 'Member Geneology',
                hidden: true,
            ...
            },
            {
                path: 'downlines',
                component: () =>
                    import ('@/views/user/network/downlines'),
                name: 'Downlines',
            ...
            }, ,
            {
                path: 'referrals',
                component: () =>
                    import ('@/views/user/network/referrals'),
                name: 'Referrals',
                hidden: false,
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'products',
                component: () =>
                    import ('@/views/user/shopping/products'),
                name: 'Cat Products',
                hidden: true,
            ...
            },
            {
                path: 'product/:id',
                component: () =>
                    import ('@/views/user/shopping/product'),
                name: 'Product',
                hidden: true,
            ...
            },
            {
                path: 'cart',
                component: () =>
                    import ('@/views/user/shopping/cart'),
                name: 'Cart',
            ...
            },
            {
                path: 'checkout',
                component: () =>
                    import ('@/views/user/shopping/checkout'),
                hidden: true,
                name: 'Checkout',
            ...
            },
            {
                path: 'orders',
                component: () =>
                    import ('@/views/user/shopping/orders'),
                name: 'Orders',
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'pending-pin-requests',
                component: () =>
                    import ('@/views/user/pins/pending-pin-requests'),
                name: 'PIN Requests',
            ...
            },
            {
                path: 'transfer',
                component: () =>
                    import ('@/views/user/pins/transfer'),
                name: 'Transfer Pins',
            ...
            },
            {
                path: 'transfer-log',
                component: () =>
                    import ('@/views/user/pins/pin-transfer-logs'),
                name: 'Pin Transfer Log',
...

            {
                path: 'approved-pin-requests',
                component: () =>
                    import ('@/views/user/pins/approved-pin-requests'),
                name: 'Approved Requests',
            ...
            },
            {
                path: 'rejected-pin-requests',
                component: () =>
                    import ('@/views/user/pins/rejected-pin-requests'),
                name: 'Rejected Requests',
    ...
    },
    {
        ...
        children: [{
                path: 'wallet',
                component: () =>
                    import ('@/views/user/wallet/index'),
                name: 'My Wallet',
            ...
            },
            {
                path: 'income-wallet',
                component: () =>
                    import ('@/views/user/wallet/incomewallet'),
            ...
            },
            {
                path: 'credit-requests',
                component: () =>
                    import ('@/views/user/wallet/credit-requests'),
                name: 'Credit Requests',
            ...
            },
            {
                path: 'withdrawals',
                component: () =>
                    import ('@/views/user/wallet/withdrawals'),
                name: 'Withdrawals',
            ...
            },
            {
                path: 'transfer-balance',
                component: () =>
                    import ('@/views/user/wallet/transfer'),
                name: 'Transfer Balance',
            ...
            },
            {
                path: 'wallet-transactions',
                component: () =>
                    import ('@/views/user/wallet/transactions'),
                name: 'Wallet Transactions',
            ...
            },
            {
                path: 'income-wallet-transactions',
                component: () =>
                    import ('@/views/user/wallet/income-transactions'),
                name: 'Income Wallet Trans',
            ...
            },
            {
                path: 'luxury-wallet-transactions',
                component: () =>
                    import ('@/views/user/wallet/luxury-wallet-transactions'),
                name: 'Luxury Wallet Trans',
...

    {
        ...
        children: [{
                path: 'all',
                component: () =>
                    import ('@/views/user/payouts/generate'),
                name: 'My Payout',
            ...
            },
            {
                path: 'incomes',
                component: () =>
                    import ('@/views/user/payouts/incomes'),
                name: 'Incomes',
            ...
            },
            {
                path: 'rewards',
                component: () =>
                    import ('@/views/user/payouts/reward'),
                name: 'Rewards',
            ...
            },
            {
                path: 'income-holdings',
                component: () =>
                    import ('@/views/user/payouts/income-holdings'),
                name: 'Income on Hold',
                hidden: true,
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path: 'daily-bv',
                component: () =>
                    import ('@/views/user/reports/daily-bv'),
                name: 'BV History',
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/user/reports/group-and-matching'),
            ...
            },
            {
                path: 'personal-pv',
                component: () =>
                    import ('@/views/user/reports/personal-pv-monthly'),
            ...
            },
            {
                ...
                component: () =>
                    import ('@/views/user/reports/affiliate-bonus'),
    ...
    },
    {
        ...
        children: [{
            path: 'my-tickets',
            component: () =>
                import ('@/views/user/support/index'),
