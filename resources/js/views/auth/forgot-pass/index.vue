      ...
      <div class="login-container">
        <el-form ref="forgotPassForm" :model="forgotPassForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
          ...
          <el-form-item prop="email">
            ...
            <el-input v-model="forgotPassForm.email" name="email" type="text" auto-complete="on" placeholder="Enter email address" />
          </el-form-item>
  ...
  methods: {
    ...
    handleForgotPassword() {
      this.$refs.forgotPassForm.validate(valid => {
        if (valid) {
          this.loading = true;
            resetPassword(this.forgotPassForm).then((response) => {
            this.$notify({
              title: "Success",
