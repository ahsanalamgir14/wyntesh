        ...
        <el-row :gutter="20">
          ...
          <el-col  :xs="24" :sm="24" :md="24" :lg="24" :xl="24" >
                ...
                <el-form-item prop="member_name" label="Member Name">             
                    <el-input disabled v-model="temp.member_name" name="name" type="text" auto-complete="on" placeholder="Enter Member Name" />
                </el-form-item>

                <el-form-item prop="amount" label="Amount">             
                    <el-input v-model="temp.amount" name="amount" type="number" auto-complete="on" placeholder="Enter Name Amount" @change="handleTdsAmountCal"/>
                </el-form-item>
...
<script>
import { fetchRewards} from "@/api/user/payouts";
