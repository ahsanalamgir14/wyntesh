<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Gross Amount" width="150px" align="right">
        <template slot-scope="{row}">
      ...
      <el-table-column label="Admin Charge" min-width="150px" align="right">
        <template slot-scope="{row}">
          <span>{{ row.admin_charge }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Payable Amount" min-width="150px" align="right">
        <template slot-scope="{row}">
