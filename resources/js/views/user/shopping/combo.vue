            ...
            <el-row id="productsScroll" style="max-height:calc(100% - 52px); min-height:calc(100% - 52px); overflow:auto">
                <div v-for="comboCategory in combo.categories" :key="comboCategory.id" v-if="comboCategory">
                    <el-card class="box-card rounded-lg mb-2" :body-style="{ padding: '0.5rem' }" shadow="never" v-for="quantity in comboCategory.quantity" :key="quantity">
                        ...
                        <el-row :gutter="10" v-if="selectedCategoryProducts[comboCategory.category_id + '_' + quantity]">
                            <el-col>
                                            ...
                                            <span class="text-gray-700 mt-3 ">DP - ₹ {{comboCategory.dp_amount}} /-
                                                <el-popover placement="right" width="200" trigger="hover">
                                                    ...
                                                    <div style="margin-left: 5px;">
                                                        <p><b>Base price</b> : {{comboCategory.dp_base}}</p>
                                                        <p><b>GST</b> : {{comboCategory.dp_gst_amount}}</p>
        ...
        <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
            <div class="shopping-cart rounded-lg shadow" v-if="combo.length != 0">
                ...
                <div class="calculations mt-4">
                    ...
                    <div class="cal-amount"><span>{{combo.base_amount | convert_with_symbol}}</span></div>
                </div>
                ...
                <div class="calculations">
                    ...
                    <div class="cal-amount"><span>{{combo.pv}}</span></div>
                </div>
                <div class="calculations">
                    <div class="cal-grand">
                ...
                <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
                    <div class="shopping-cart" style="margin-top: 20px;">
                        ...
                        <div class="make-payment-btn">
                            <el-button class="checkout" type="success" round size="large" icon="el-icon-shopping-cart-full" :loading="buttonLoading" @click="placeCombo()">Make Payment</el-button>
                        </div>
                    </div>
                </el-col>
            </el-form>
                    ...
                    <el-form-item label="Mobile Number" prop="mobile_number">
                        <el-input v-model="tempAddress.mobile_number" type="text" auto-complete="on" placeholder="Enter valid Mobile No.">
                            <el-select v-model="tempAddress.country_code" class="countryFlag" slot="prepend" placeholder="Country" filterable prop="country_code" style="width: 110px !important;">
                                <el-option v-for="item in Country" :key="item.city_country" :label="item.phonecode+'  '+item.country_img" :value="item.phonecode">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                    ...
                    <el-form-item label="Country" prop="country">
                        <el-select v-model="tempAddress.country" style="width: 100%" filterable @change="handleCountryChange" placeholder="Select Country">
                            <el-option v-for="item in Country" :key="item.country_img" :label="item.city_country" :value="item.city_country">
