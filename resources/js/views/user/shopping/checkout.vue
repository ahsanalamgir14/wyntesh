  ...
  <div class="app-container">
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
        <div class="shopping-cart">
          ...
          <div class="item" v-for="product in cartProducts" :key="product.id">
            <div class="buttons">
              <el-button type="danger" icon="el-icon-delete" circle :loading="buttonLoading" @click="removeFromCart(product.product_id)"></el-button>
            </div>
            <!-- <div class="image">
    ...
    <el-row :gutter="20" v-if="step==1" style="margin-top: 20px;">
      <div class="filter-container">
        <el-button class="filter-item" style="margin-left: 10px;" type="warning" @click="step=0"><i class="fas fa-arrow-left"></i> Back</el-button>
        <el-button class="filter-item" style="margin-right: 10px;float: right;" type="success" @click="$router.push('/my/addresses')"><i class="fas fa-plus"></i> Add Address</el-button>
      </div>
      <el-form ref="orderForm" :rules="orderRules" :model="temp">
        <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
          ...
          <el-form-item label="Address" prop="address">
            <el-input type="textarea" disabled :rows="2" placeholder="Address" v-model="shipping_address.address">
            </el-input>
          </el-form-item>
        ...
        <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="8">
          ...
          <el-form-item label="Address" prop="address">
            <el-input type="textarea" disabled :rows="2" placeholder="Address" v-model="billing_address.address">
            </el-input>
          </el-form-item>
          <el-form-item label="Lanmark" prop="landmark">
