  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Member ID" width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleEdit(row)">{{ row.member?row.member.code:'-' }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Gross Amount" width="150px">
        <template slot-scope="{row}">
          <span>{{ row.gross_amount }}</span>
        </template>
      </el-table-column>  
      <el-table-column label="TDS" width="150px" >
        <template slot-scope="{row}">
          <span>{{ row.tds }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Admin Charge" min-width="150px" >
        <template slot-scope="{row}">
      ...
      <el-table-column label="Status" class-name="status-col" width="100">
        <template slot-scope="{row}">
          <el-tag :type="row.is_paid | statusFilter">{{ row.is_paid?'Paid':'Unpaid' }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="Details" min-width="150px" >
        <template slot-scope="{row}">
