            ...
            <router-link to="/reports/group-and-matching">
              <div class="card-panel gr2" >
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="temp.gmember.leg_pv[1]?dashboardStats.member.gmember.leg_pv[1]:0" :duration="3600" class="card-panel-num" />
                  <div class="card-panel-text">
                    Leg A
                  </div>
                </div>
            ...
            <router-link to="/reports/group-and-matching">
              <div class="card-panel gr2" >
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="temp.gmember.leg_pv[2]?dashboardStats.member.gmember.leg_pv[2]:0" :duration="3600" class="card-panel-num" />
                  <div class="card-panel-text">
                    Leg B
                  </div>
                </div>
            ...
            <router-link to="/reports/group-and-matching">
              <div class="card-panel gr2" >
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="temp.gmember.leg_pv[3]?dashboardStats.member.gmember.leg_pv[3]:0" :duration="3600" class="card-panel-num" />
                  <div class="card-panel-text">
                    Leg C
                  </div>
                </div>
            ...
            <router-link to="/reports/group-and-matching">
              <div class="card-panel gr2" >
                ...
                <div class="card-panel-description">
                  ...
                  <count-to :start-val="0" :end-val="temp.gmember.leg_pv[4]?dashboardStats.member.gmember.leg_pv[4]:0" :duration="3600" class="card-panel-num" />
                  <div class="card-panel-text">
                    Leg A
                  </div>
                </div>
