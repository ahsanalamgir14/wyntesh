          ...
          <div class="user-profile">
            ...
            <div class="box-center">
              <div class="user-name text-center">
                <span>{{ temp.name }}</span>
                <br>
                <div ><span>{{ temp.username }}</span></div>
                <div >
        ...
        <el-row :gutter="10" class="panel-group">
          ...
          <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
            <router-link to="/member/payouts/all">
              <div class="shadow-md p-2 pl-4 pt-1 pr-1 md:pr-3 bg-red-400 rounded-md overflow-hidden">
                <div class="text-2xl font-bold leading-8 mt-2 text-white">{{parseFloat(dashboardStats.total_payout)}}</div>
                <div class="text-xs font-bold mt-1 text-white">Total Payout </div>
              </div>
            </router-link>
          </el-col>
           <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
...
export default {
  ...
  methods: {
    ...
    getCarryForward(position){
      let cf=this.temp.gmember.carry_forward;
      if(!cf)
        return 0;
