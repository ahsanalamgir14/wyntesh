<template>
  <div class="dashboard-editor-container">
    <el-alert v-if="notice.is_active" style="margin-bottom: 10px;" :title="notice.title" type="success" :description="notice.description" show-icon>
    </el-alert>
    <el-alert v-if="!temp.is_active" style="margin-bottom: 10px;" title="ID Activation Notice" type="error" description="Your ID is inactive, kindly fullfill minimum business criteria to activate ID" show-icon>
    </el-alert>
    <el-row :gutter="10">
              ...
              <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
                <router-link to="/reports/group-and-matching">
                  <div class="card-panel gr2">
                    ...
                    <div class="card-panel-description">
                      <count-to :start-val="0" :end-val="temp.gmember.leg_pv[1]?parseInt(dashboardStats.member.gmember.leg_pv[1]):0" :duration="3600" class="card-panel-num" />
                      <div class="card-panel-text">
                        Leg A
                      </div>
                    </div>
              ...
              <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
                <router-link to="/reports/group-and-matching">
                  <div class="card-panel gr2">
                    ...
                    <div class="card-panel-description">
                      <count-to :start-val="0" :end-val="temp.gmember.leg_pv[2]?parseInt(dashboardStats.member.gmember.leg_pv[2]):0" :duration="3600" class="card-panel-num" />
                      <div class="card-panel-text">
                        Leg B
                      </div>
                    </div>
              ...
              <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
                <router-link to="/reports/group-and-matching">
                  <div class="card-panel gr2">
                    ...
                    <div class="card-panel-description">
                      <count-to :start-val="0" :end-val="temp.gmember.leg_pv[3]?parseInt(dashboardStats.member.gmember.leg_pv[3]):0" :duration="3600" class="card-panel-num" />
                      <div class="card-panel-text">
                        Leg C
                      </div>
                    </div>
    ...
    <el-row :gutter="10" style="margin-top: 20px;">
      <el-col :xs="24" :sm="24" :md="12" :lg="12">
        <el-card shadow="never">
          ...
          <el-table :data="downlines" style="width: 100%" border>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="12">
        <el-card shadow="never">
          ...
          <el-table :data="transitions" style="width: 100%" border>
